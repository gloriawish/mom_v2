...
//		producerListener.onError(cause);
	...
	public void channelInactive(ChannelHandlerContext ctx) throws Exception {
		...
		System.out.println("send time:"+UseTimeTool.sendTime+"ms"+" send number:"+UseTimeTool.sendNumber);
		System.out.println("send speed:"+(UseTimeTool.sendNumber/(UseTimeTool.sendTime/1000F)));
	}
